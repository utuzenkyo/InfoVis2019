function main()
{
    ...
    {
        var id = faces[i];
        var S0 = parseInt(Math.round((scalars[ id[0] ]-0.1)*255/0.7));
        var S1 = parseInt(Math.round((scalars[ id[1] ]-0.1)*255/0.7));
        var S2 = parseInt(Math.round((scalars[ id[2] ]-0.1)*255/0.7));
